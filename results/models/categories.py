...
from results.models.competitions import CompetitionResultType, CompetitionType
...
class CategoryForCompetitionType(LogChangesMixing, models.Model):
    ...
    limit_partial = models.ManyToManyField(
        CompetitionResultType, blank=True, verbose_name=_("No partial records for listed result types")
    )
