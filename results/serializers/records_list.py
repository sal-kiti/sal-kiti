...
class RecordListSerializer(serializers.ModelSerializer, EagerLoadingMixin):
    ...
    _PREFETCH_RELATED_FIELDS = [
        ...
        "result__team_members__additional_organizations",
        "result__team_members__info__sport",
        "result__team_members__organization",
        "result__team_members__organization__areas",
        "partial_result",
